...
import {addToCart, updateCart, setCartVendor} from '../../Core/cart/redux/actions';
...
class SingleItemDetail extends React.Component {
  ...
  onAddToCart = () => {
    ...
    if (
      ...
      alert(IMLocalized("You're trying to add an item from a different vendor. Please remove all the other items in the cart first."));
      return;
    }
