...
const VendorAppConfig = {
  ...
  onboardingConfig: {
    ...
    welcomeCaption: IMLocalized('Enable your customers to order from you. We take care of the delivery.'),
    walkthroughScreens: [
      {
        icon: require("../assets/icons/restaurant-menu.png"),
        title: IMLocalized("Welcome to InstaEats"),
        description: IMLocalized("Log in and order delicious food from restaurants around you.")
      },
      {
        icon: require("../assets/icons/delivery-icon.png"),
        title: IMLocalized("Food ordering"),
        description: IMLocalized("Your customer can start ordering food from your restaurant right now.")
      },
      {
        icon: require("../assets/icons/binoculars.png"),
        title: IMLocalized("Delivery"),
        description: IMLocalized("All the orders your restaurant accepts are delivered by our drivers.")
      },
      {
        icon: require("../assets/icons/apple.png"),
        title: IMLocalized("Seamless Payments"),
        description: IMLocalized("We handle payments and the delivery infrastructure.")
      }
    ]
  },
